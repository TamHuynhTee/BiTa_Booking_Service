...
router.get('/get-branch-by-id', auth(), validate(branchValidation.getBranchById), branchController.getBranchById);
router.get('/query-branch', validate(branchValidation.queryBranches), branchController.queryBranches);
